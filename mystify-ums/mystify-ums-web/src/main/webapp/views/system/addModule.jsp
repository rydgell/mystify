...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="cssposition">
  <tr>
    <td width="54"><img src="${ROOT}/images/subnav1.jpg" width="94" height="30" /></td>
    	<td style="background:url(${ROOT}/images/subnav.jpg) repeat-x" class="subnavcss">模块管理&gt; 新增模块</td>
  </tr>
</table>
	
	
	<form id="moduleForm" action="${ROOT}/addModule.do"  method="post">
		<table width="100%" cellpadding="5" cellspacing="1" bgcolor="#d0d7e5" style="margin:10px 0px;" align="center"   class="systemtable">
			<tr>
				...
				<td align="left" bgcolor="#FFFFFF"><input type="text" class="easyui-validatebox" required="true" id="name" maxlength="30" name="name"><font color="red">*</font></td>
			</tr>
			<tr>
